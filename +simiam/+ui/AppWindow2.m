   ...
   methods 
       ...
       function create_simulator(obj, settings_file, h_map)
        ...
        function init_buttons(obj)
            ...
            obj.ui_toggle_control(zoom_in, true);
            ...
            obj.ui_toggle_control(zoom_out, true);
        ...
        function ui_button_start(obj, src, event)
            ...
            %obj.ui_toggle_control(obj.ui_buttons_., true);
            obj.ui_toggle_control(obj.ui_buttons_.load, true);
