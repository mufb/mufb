...
% see the LICENSE file included with this software
    ...
    %% METHODS
        ...
        function obj = K3Supervisor(goal)
        %% SUPERVISOR Constructor
            ...
            obj.eventsd{8} = struct('event', 'at_base', ...
                                    'callback', @at_base);
...
%                 fprintf('stopped at (%0.3f,%0.3f)\n', x, y);
            ...
            elseif(obj.check_event('unsafe'))
                ...
                if (obj.is_in_state('go_to_goal') || obj.is_in_state('go_to_base'))
...
%                 fprintf('now sliding right\n');
        ...
        function rc = at_base(obj, state, robot)
            [x,y,theta] = obj.state_estimate.unpack();
            rc = false;
