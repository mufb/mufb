classdef GoToBase < simiam.controller.Controller
%% GOTOBASE steers the robot towards a base with a constant velocity using PID
%
% Properties:
%   none
%
% Methods:
%   execute - Computes the left and right wheel speeds for go-to-base.
...
% see the LICENSE file included with this software
    ...
    %% METHODS
        ...
        function obj = GoToBase()
            %% GOTOGOAL Constructor
            obj = obj@simiam.controller.Controller('go_to_base');
