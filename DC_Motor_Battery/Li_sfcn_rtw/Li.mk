...
MODEL              = Li
MODULES            = Li_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = Li.mk
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  GENERATE_REPORT=0 MODELLIB=Lilib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Li_sfcn_rtw
